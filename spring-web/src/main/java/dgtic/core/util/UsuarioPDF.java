...
public class UsuarioPDF  extends AbstractPdfView {
    ...
    protected void buildPdfDocument(Map<String, Object> model
        ...
        //LOS DATOS SE RECIBEN A TRAVEZ DEL MODEL

        List<UsuarioBd> datos=(List<UsuarioBd>) model.get("datos");
        //ruta para almacenar la informacion
        String ruta=(String) model.get("ruta");
        //construir lla extension del archivo
        String rutaAlm=ruta+"temp.pdf";
        //traer el documento para abrirlo y apartir de ahi construir el pdf
        PdfWriter.getInstance(document,new FileOutputStream(rutaAlm));
        document.open();

        //crear una tabla documentacion -> openPdf
